...
class _MyHomePageState extends State<HomePage> {
  ...
  listitem() {
    return Consumer<ListController>(builder: (context, listcontroller, child) {
  ...
  card(bool done, int index) {
    return Consumer<ListController>(builder: (context, listcontroller, widget) {
      return Column(
        children: [
          Container(
            height: 80,
                  ...
                  children: [
                    Checkbox(
                        ...
                        onChanged: (_) async {
                          try {
                            ...
                            var body = {
                              'title': listcontroller.list.items[index].title,
                              'done': _
                            };
                            await Provider.of<APIController>(context,
                                    listen: false)
                                .updateTask(
                                    "todos/${listcontroller.list.items[index].id}",
                                    body,
                                    context);
                            listcontroller.toggleCheck(
                                listcontroller.list.items[index], index, _!);
                          } catch (e) {
                            log(e.toString());
                          }
                        }),
                    Container(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                            decoration:
                                listcontroller.list.items[index].done == true
